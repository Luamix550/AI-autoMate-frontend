            ...
            <div className='pb-8'>
                <div className="max-w-md p-8 text-white ">
                    ...
                    <div className='bg-gradient-to-b from-black from-75% to-violet-900 hover:duration-200 grid justify-items-center rounded-3xl py-6 md:py-5 shadow-md shadow-purple-600 border-[1px] hover:shadow-violet-500 hover:shadow-lg border-purple-950'>
                        <h2 className="text-2xl m-1 md:m-0 font-bold hover:drop-shadow-[0_0_0.3rem_#ffffff70] text-gray-200 hover:duration-300 text-center">Sign In</h2>
                        <form novalidate="" action="" className="space-y-2 md:space-y-1">
                            <div className="text-sm">
                                <label for="username" className="block">Username</label>
                                <input type="text" name="username" id="username" placeholder="Username" className="w-full md:h-full md:text-[15px] px-4 py-2 md:py-1 rounded-md border-gray-700 focus:border-transparent bg-black" />
                            </div>
                            <div className=" text-sm">
                        ...
                        <div className="flex justify-center space-x-4">
                            <button aria-label="Log in with Google" className="p-3 m-2 border hover:duration-400 hover:shadow-xl hover:bg-white hover:text-black hover:border-purple-900 hover:shadow-purple-700 border-purple-200 rounded-full ">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                                    <path d="M16.318 13.714v5.484h9.078c-0.37 2.354-2.745 6.901-9.078 6.901-5.458 0-9.917-4.521-9.917-10.099s4.458-10.099 9.917-10.099c3.109 0 5.193 1.318 6.38 2.464l4.339-4.182c-2.786-2.599-6.396-4.182-10.719-4.182-8.844 0-16 7.151-16 16s7.156 16 16 16c9.234 0 15.365-6.49 15.365-15.635 0-1.052-0.115-1.854-0.255-2.651z"></path>
                                </svg>
                            </button>
                            <button aria-label="Log in with Twitter" className="p-3 m-2 border border-purple-200 hover:duration-400 hover:shadow-xl hover:bg-white hover:text-black hover:border-purple-900 hover:shadow-purple-700 rounded-full">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                            ...
                            <button aria-label="Log in with GitHub" className="p-3 m-2 border border-purple-200 hover:duration-400 hover:shadow-xl hover:bg-white hover:text-black hover:border-purple-900 hover:shadow-purple-700 rounded-full">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
